...
export const templates: Template[] = [
  {
    ...
    description:
      "Emphasizes loyalty, family motivation, and unwavering work ethic. Honest about why you work hard. Adapts to job description keywords.",
...
Structure:
Paragraph 1: Introduce myself and the role I am applying for. Mention my genuine love for web development and building things with code. If the job description mentions specific technologies, subtly reference your experience with similar ones.

Paragraph 2: Talk about my strong work ethic and loyalty. Briefly and honestly mention my family situation and that I am deeply motivated by the need to provide for my loved ones. If the job description mentions soft skills like teamwork, communication, or problem-solving, you can naturally weave in that I bring these qualities.
